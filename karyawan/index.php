...
<body>
    ...
    <div class="content" id="content">
        ...
        <nav
            ...
            <span class="navbar-brand fw-semibold">Kelola Karyawan</span>
        ...
        <!-- TABEL -->
        <a href="create.php" class="btn btn-dark mb-3  "><i class="fa-solid fa-address-card me-2"></i>Tambah
            Karyawan
            Baru</a>
        <div class="card p-4 shadow-sm rounded mb-4">
            <h5 class="mb-3">Data Karyawan <i class="fa-solid fa-address-card me-2"></i></h5>
                ...
                <table class="table table-bordered table-striped text-nowrap">
                    ...
                    <tbody>
                        ...
                        <?php
                            ...
                            $namaPerusahaan = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM perusahaan WHERE id='$perusahaan_id'"))?>
                        <tr>
                            <td><?= $i++ ?></td>
                            <td><?= $data['nama'] ?></td>
                            <td><?= $data['jabatan'] ?></td>
                        ...
                        <form action="edit.php" method="POST">
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="rek_bank" class="form-select" required>
                                        <?php foreach ($bankList as $bank): ?>
                                        <option value="<?= $bank ?>"
                                            <?= ($bank === $data['rek_bank']) ? 'selected' : '' ?>>
                                            <?= $bank ?>
                                        </option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="id_perusahaan" class="form-select " aria-label="Default select ">
                                        <option selected value="<?= $data['id_perusahaan'] ?>">
                                            <?= $namaPerusahaan['nama'] ?>
                                        </option>
