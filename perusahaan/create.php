...
if(isset($_POST['tambah'])){
    ...
    $stmt = $conn->prepare('INSERT INTO perusahaan (nama, alamat, no_hp, email) VALUES (?,?,?,?)');
...
<head>
    ...
    <title>TAMBAH PERUSAHAAN - PAYROLL</title>
...
<body>
    ...
    <div class="content" id="content">
        ...
        <nav
            ...
            <span class="navbar-brand fw-semibold">Tambah Perusahaan</span>
