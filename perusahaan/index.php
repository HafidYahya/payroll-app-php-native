...
<head>
    ...
    <title>PERUSAHAAN - PAYROLL</title>
...
<body>
    ...
    <div class="content" id="content">
        ...
        <nav
            ...
            <span class="navbar-brand fw-semibold">Kelola Perusahaan</span>
        ...
        <!-- TABEL -->
        <a href="create.php" class="btn btn-dark mb-3  "><i
                class="fa-solid fa-building-circle-arrow-right me-2"></i>Tambah
            Perusahaan
            Baru</a>
        <div class="card p-4 shadow-sm rounded mb-4">
            <h5 class="mb-3">Data Perusahaan <i class="fa-solid fa-building"></i></h5>
    ...
    Toast.fire({
        icon: "success",
        title: "Berhasil menambahkan perusahaan baru"
    });
    </script>
    <?php endif; ?>
