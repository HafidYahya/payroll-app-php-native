...
$query = "SELECT * FROM keterangan_gaji";
...
<head>
    ...
    <title>KETERANGAN GAJI - PAYROLL</title>
...
<body>
    ...
    <div class="content" id="content">
        ...
        <nav
            ...
            <span class="navbar-brand fw-semibold">Kelola Keterangan Gaji</span>
        ...
        <!-- TABEL -->
        <a href="create.php" class="btn btn-dark mb-3  "><i class="fa-solid fa-money-bill-transfer me-2"></i>Tambah
            Keterangan
            Baru</a>
        <div class="card p-4 shadow-sm rounded mb-4">
            <h5 class="mb-3">Data Keterangan Gaji <i class="fa-solid fa-money-bill-transfer me-2"></i></h5>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p class="mb-0">
                                            Apakah Anda yakin ingin menghapus ketengan gaji:
                                    ...
                                    <form action="edit.php" method="POST">
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="tipe" class="form-select " aria-label="Default select ">
                                                    <option value="pemasukan"
                                                        <?= $data['tipe'] == 'pemasukan' ? 'selected' : '' ?>>
                                                        Pemasukan
                                                    </option>
                                                    <option value="potongan"
                                                        <?= $data['tipe'] == 'potongan' ? 'selected' : '' ?>>
                                                        Potongan
                                                    </option>
                                                </select>
                                            </div>
    ...
    Swal.fire({
        icon: 'success',
        title: 'Berhasil!',
        text: 'Data keterangan gaji berhasil diperbarui!',
        timer: 1500,
    ...
    Toast.fire({
        icon: "success",
        title: "Berhasil menambahkan keterangan gaji baru"
    });
    </script>
    <?php endif; ?>
